"""Rack Power Autopilot — SCAFFOLD STUB.

Company lens: CoreWeave (independent; no affiliation).
Bottleneck: Power, hardware reliability, scheduling, checkpointing, recovery, and utilization at cluster scale.
...
class RackPowerAutopilot:
    ...
    - `evaluate(req)` returns a RackPowerAutopilotReceipt
    ...
    def evaluate(self, req: RackPowerAutopilotRequest) -> RackPowerAutopilotReceipt:
        ...
        if reasons:
            ...
            return RackPowerAutopilotReceipt(
